use crate::invalid_id::is_repeated;
use crate::puzzle::Puzzle;

fn sum_of_invalid_ids_in(it: impl Iterator<Item = u64>) -> u64 {
    it.filter(|&n| is_repeated(n)).sum()
}
...
mod test {
    ...
    fn test_sum_of_invalid_ids_in_range() {
        ...
        assert_eq!(sum_of_invalid_ids_in(95..=115), 210);
        assert_eq!(sum_of_invalid_ids_in(998..=1012), 2009);
        ...
        assert_eq!(sum_of_invalid_ids_in(565653..=565659), 565656);
        assert_eq!(sum_of_invalid_ids_in(824824821..=824824827), 824824824);
        assert_eq!(sum_of_invalid_ids_in(2121212118..=2121212124), 2121212121);
    }

    #[test]
    fn test1() {
        assert_eq!(run(crate::data::EXAMPLE1), 4174379265);
    }
}
